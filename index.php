...
#the variable is inside the function indexes
...
# changed quotes marking the string
...
#changed value wasn't really assigned
foreach($week as &$day) {
...
# added condition for single characters
$arr = [];
for ($letter = 'a'; $letter <= 'z' && strlen($letter) === 1  ; $letter++) {
